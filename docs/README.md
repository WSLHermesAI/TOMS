...
| [`EngineBlueprint/`](EngineBlueprint/) | **Planning doc for the next project**: a reusable C++ engine with Magic Tower as its first game. Covers the layered system hierarchy (72 engine/tool systems + 12 game systems), build-vs-adopt cards, third-party library shortlist, resource/lifetime management, 2D+3D rendering, the in-game editor with prefabs and code binding, the Visual Studio workflow, and a milestone plan. Start at `EngineBlueprint/README.md`. |
