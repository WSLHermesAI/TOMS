...
>   release to freeze it" (today's shipped Power Bar, `docs/design/FIGHT_SCENE_DESIGN.md` §2), the marker now
...
>
> This does not touch `docs/design/MAIN_BATTLE_SCENE_DESIGN.md`'s equipment system or damage formulas — the
...
dice roll, consistent with this project's no-RNG pillar (`docs/design/GAME_DESIGN_DOCUMENT.md` §1/§16).
...
DEFENSE bar:   identical auto-bounce, its own independent geometry/speed (as today, Defense has
               a shorter rampTime than Attack -- docs/design/FIGHT_SCENE_DESIGN.md §5)
...
| Attack bar speed/geometry | unchanged from `docs/design/FIGHT_SCENE_DESIGN.md` §5 (`v0=15, vmax=200, rampTime=1.8s`) |
| Defense bar speed/geometry | unchanged from `docs/design/FIGHT_SCENE_DESIGN.md` §5 (`v0=18, vmax=220, rampTime=1.4s`) |
...
`docs/design/MAIN_BATTLE_SCENE_DESIGN.md` §4.3 already carries for its equipment numbers.
...
- `docs/design/MAIN_BATTLE_SCENE_DESIGN.md` — update §2 (screen layout: both bars are now on-screen and
