// run_state.h — the per-run story state introduced by S3 (docs/STORY_DATA_SCHEMA.md sections 2.3/9).
//
...
//   * rebirth (docs/STORY_DATA_SCHEMA.md section 8) is defined as "reset this, keep shards + meta",
