...
// live in docs/ART_AND_ABILITY_DESIGN.md section 1.7 (F1-F8).
//
...
inline FootprintSpec footprintSpecFromJson(const nlohmann::json& j, const std::string& key) {
    ...
    if (!spec.fp.valid()) {
        fprintf(stderr,
                ...
                "2x2 are allowed -- docs/ART_AND_ABILITY_DESIGN.md section 1.7); using 1x1\n",
...
// Three sources, in priority order (docs/ART_AND_ABILITY_DESIGN.md F8: 佔格 is a *character-level*
