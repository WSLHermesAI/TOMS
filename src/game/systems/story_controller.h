...
// the single source of truth for this data (see docs/architecture/IMPLEMENTATION_ROADMAP.md Milestone 3,
// which deliberately folds the "Story Controller" into it instead of duplicating state).
// See docs/architecture/GAME_LOGIC_AND_RENDERING_ARCHITECTURE.md §7.
#pragma once
