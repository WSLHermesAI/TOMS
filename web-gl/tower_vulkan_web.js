...
// include: /tmp/tmplr2c5__p.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/fatming/Desktop/TOMS/web/tower_vulkan_web.data';
      var REMOTE_PACKAGE_BASE = 'tower_vulkan_web.data';
...
Module['FS_createPath']("/data", "stages", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_/home/fatming/Desktop/TOMS/web/tower_vulkan_web.data');
      }
      Module['addRunDependency']('datafile_/home/fatming/Desktop/TOMS/web/tower_vulkan_web.data');
...
function findWasmBinary() {
  return locateFile('tower_vulkan_web.wasm');
}
